 ...
 * satu mutasi hilang. Untuk `campaigns.totalClaims` itu berarti batas kuota
 * tidak pernah ditegakkan; untuk `wallets.balance` berarti kreator dibayar
 ...
 *   - campaign-claimed/src/atomic.js  ← berkas ini
 *   - expire-stale-claims/src/atomic.js
