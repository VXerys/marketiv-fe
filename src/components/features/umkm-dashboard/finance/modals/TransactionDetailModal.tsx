  ...
  return (
    <ResponsiveModal open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <ResponsiveModalContent className="max-w-lg w-full p-0 overflow-hidden">
        ...
        {/* Body */}
        <div className="p-6 overflow-y-auto space-y-6 text-sm max-h-[70vh]">
        ...
        {/* Footer Actions */}
        <ResponsiveModalFooter className="px-5 py-4.5 border-t border-neutral-200/50 bg-neutral-50/50 flex justify-end">
