...
import { DashboardMetricCard } from "@/components/features/dashboard/shared";
...
export function CampaignOverviewCards({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 shrink-0">
      {cardData.map((card, i) => (
        <DashboardMetricCard
          key={i}
          label={card.label}
