  ...
  return (
    <>
      <div className="my-5 flex items-center gap-3">
        ...
        <span className="text-[0.68rem] font-extrabold uppercase tracking-widest text-text-muted">
          atau
        </span>
        <span className="h-px flex-1 bg-neutral-200" />
      </div>
      ...
      <button
        ...
        className="flex min-h-[46px] w-full items-center justify-center gap-2.5 rounded-full border border-neutral-200/80 bg-white px-5 text-xs sm:text-sm font-extrabold text-ink-950 shadow-2xs hover:bg-neutral-50 active:scale-[.98] transition-all cursor-pointer disabled:pointer-events-none disabled:opacity-60"
      >
