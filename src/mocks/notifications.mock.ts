...
export const mockKreatorNotifications: AppNotification[] = [
  ...
  { id: "k3", type: "campaign", title: "Proof of Work Disetujui", message: "UMKM 'Sambal Bu Rudi' menyetujui konten Anda untuk campaign 'Glow & Beauty Care'. Saldo segera dicairkan.", timestamp: new Date(Date.now() - 2 * 3600000).toISOString(), isRead: false, actionLabel: "Lihat Job Pool", actionHref: "/dashboard/kreator/job-pool" },
  ...
  { id: "k8", type: "campaign", title: "Campaign Hampir Berakhir", message: "Campaign 'Warung Digital Pak Budi' berakhir dalam 3 hari. Segera upload proof of work Anda.", timestamp: new Date(Date.now() - 3 * 86400000).toISOString(), isRead: true, actionLabel: "Lihat Job Pool", actionHref: "/dashboard/kreator/job-pool" },
  { id: "k9", type: "sistem", title: "Kebijakan Platform Diperbarui", message: "Marketiv memperbarui ketentuan penggunaan. Mohon baca dan setujui perubahan ini.", timestamp: new Date(Date.now() - 5 * 86400000).toISOString(), isRead: true },
...
export const mockUmkmNotifications: AppNotification[] = [
  ...
  { id: "u9", type: "sistem", title: "Laporan Bulanan Tersedia", message: "Laporan performa campaign bulan Desember 2024 siap diunduh. Total views: 125.430.", timestamp: new Date(Date.now() - 5 * 86400000).toISOString(), isRead: true },
